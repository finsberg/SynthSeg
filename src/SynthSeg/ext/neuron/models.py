    ...
    for level in range(nb_levels):
        ...
        for conv in range(
            ...
            if conv < (nb_conv_per_level - 1) or (not use_residuals):
                ...
                last_tensor = convL(nb_lvl_feats, conv_size, padding=padding, name=name)(
                    last_tensor
                )
            ...
            if conv_dropout > 0:
                ...
                last_tensor = KL.Dropout(conv_dropout, noise_shape=noise_shape, name=name)(
                    last_tensor
                )
    ...
    if do_vae:
        ...
        if ae_type == "dense":
            ...
            if (
                ...
                name = "%s_ae_sigma_enc" % prefix
                last_tensor = convL(
                    pre_enc_layer.shape.as_list()[-1], conv_size, name=name, **conv_kwargs
                )(pre_enc_layer)
